    ...
    <div className="app-shell">
      ...
      <main>
        <section id="home" className="hero section-pad">
          ...
          <div className="hero-visual reveal reveal-delay"><div className="portrait-orbit orbit-one" /><div className="portrait-orbit orbit-two" /><div className="portrait-card"><div className="portrait-placeholder"><img src="/assets/images/Professional_Profile.png" alt="Nanda Kalyan" /><div className="portrait-caption">PROFILE<br /><strong>01 — 01</strong></div></div><div className="portrait-label"><span>BASED IN INDIA</span><span>JAVA / REACT / SQL</span></div></div><div className="floating-note"><Sparkles size={15} /><span>Turning ideas<br />into products.</span></div></div>
        </section>
