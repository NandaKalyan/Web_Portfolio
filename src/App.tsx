...
const socials = [
  { label: 'GitHub', href: '[https://github.com/NandaKalyan](https://github.com/NandaKalyan)', icon: Github },
  { label: 'LinkedIn', href: '[https://www.linkedin.com/in/nanda-kalyan/](https://www.linkedin.com/in/nanda-kalyan/)', icon: Linkedin },
  { label: 'LeetCode', href: '[https://leetcode.com/u/Nanda\_Kalyan/](https://leetcode.com/u/Nanda_Kalyan/)', icon: Code2 },
];

const projects: Project[] = [
  { title: 'BiteNest', category: 'Full Stack', tags: ['Java', 'JSP', 'MySQL'], description: 'A full-stack food delivery platform supporting customers, administrators and delivery agents across the food-ordering lifecycle.', features: ['Customer and admin workflows', 'Restaurant, cart and checkout flow', 'Delivery-agent dashboard'], highlights: ['MVC-oriented architecture', 'DAO pattern', 'JDBC/MySQL integration'], githubUrl: '[https://github.com/NandaKalyan/Food\_Delivery\_App](https://github.com/NandaKalyan/Food_Delivery_App)', demoVideoUrl: '[https://www.linkedin.com/posts/nanda-kalyan\_introducing-bitenest-a-modern-food-delivery-activity-7284600230761680896-z9sh](https://www.linkedin.com/posts/nanda-kalyan_introducing-bitenest-a-modern-food-delivery-activity-7284600230761680896-z9sh)', tint: 'amber', mark: 'BN', image: '/assets/projects/bitenest.jpg' },
  { title: 'SweetJar', category: 'Full Stack', tags: ['PHP', 'MySQL', 'JavaScript'], description: 'A full-stack online sweets ordering platform with authentication, product browsing, cart management and a dedicated admin panel.', features: ['Dynamic product catalog', 'Customer checkout', 'Admin product management'], highlights: ['PHP server-side development', 'CRUD operations', 'Password hashing'], githubUrl: '[https://github.com/NandaKalyan/SweetJar](https://github.com/NandaKalyan/SweetJar)', demoVideoUrl: '[https://drive.google.com/file/d/1NJ3AS8XQ5Om1wjzllxBnZ7ARqzSZZoDu/view?usp=sharing](https://drive.google.com/file/d/1NJ3AS8XQ5Om1wjzllxBnZ7ARqzSZZoDu/view?usp=sharing)', tint: 'rose', mark: 'SJ', image: '/assets/projects/sweetjar.jpg' },
  { title: 'TestCraft AI', category: 'AI', tags: ['React', 'TypeScript', 'GitHub API'], description: 'An AI-assisted developer testing platform that analyzes GitHub source code and generates structured test cases and test code.', features: ['Repository discovery', 'Source-code processing', 'Multi-language testing workflows'], highlights: ['GitHub API integration', 'OAuth authentication', 'Jest, pytest and JUnit workflows'], githubUrl: '[https://github.com/NandaKalyan/TestCraft-AI](https://github.com/NandaKalyan/TestCraft-AI)', liveDemoUrl: '[https://nk-testcraft-ai.netlify.app](https://nk-testcraft-ai.netlify.app)', tint: 'cyan', mark: 'TC', image: '/assets/projects/testcraft-ai.png' },
  { title: 'Thronex AI Assistant', category: 'Python', tags: ['Python', 'APIs', 'Voice'], description: 'A Python voice assistant combining speech recognition, text-to-speech, APIs and desktop automation for everyday commands.', features: ['Voice recognition', 'News and weather information', 'Application and browser launching'], highlights: ['Speech processing', 'REST API integration', 'Command routing'], githubUrl: '[https://github.com/NandaKalyan/Thronex\_Ai\_Assistant](https://github.com/NandaKalyan/Thronex_Ai_Assistant)', tint: 'violet', mark: 'TA', image: '/assets/projects/thronex.jpg' },
  { title: 'GAT TOUR', category: 'Android', tags: ['Java', 'Android', 'SQLite'], description: 'An Android campus navigation and information application with interactive locations, department information and local authentication.', features: ['Interactive campus map', 'Department information', 'SQLite-based storage'], highlights: ['Android SDK', 'SQLiteOpenHelper', 'Multi-screen navigation'], githubUrl: '[https://github.com/NandaKalyan/GAT-TOUR](https://github.com/NandaKalyan/GAT-TOUR)', tint: 'blue', mark: 'GT', image: '/assets/projects/gat-tour.jpg' },
  { title: 'NewsFlamingo', category: 'React', tags: ['React', 'REST API', 'Bootstrap'], description: 'A responsive React news aggregation platform retrieving categorized and language-based headlines through the GNews API.', features: ['Category and language selection', 'Live article cards', 'Progress and loading states'], highlights: ['GNews API', 'React Router', 'Infinite scroll'], githubUrl: '[https://github.com/NandaKalyan/News\_Application](https://github.com/NandaKalyan/News_Application)', liveDemoUrl: '[https://nk-news-flamingo.netlify.app](https://nk-news-flamingo.netlify.app)', tint: 'orange', mark: 'NF', image: '/assets/projects/newsflamingo.jpg' },
  { title: 'LexiPro', category: 'React', tags: ['React', 'JavaScript', 'CSS'], description: 'A text productivity application for transformation, formatting, clipboard, reading-time and typing-speed analysis.', features: ['Text transformations', 'Reading-time calculation', 'Typing-speed analysis'], highlights: ['Browser Clipboard API', 'Responsive UI', 'Dark and light modes'], githubUrl: '[https://github.com/NandaKalyan/Text-Utils-Lexi-pro](https://github.com/NandaKalyan/Text-Utils-Lexi-pro)', liveDemoUrl: '[https://nk-text-utils.netlify.app](https://nk-text-utils.netlify.app)', tint: 'lime', mark: 'LP', image: '/assets/projects/lexipro.png' },
  { title: 'Dynamic English Dictionary', category: 'JavaScript', tags: ['JavaScript', 'REST API', 'Fetch'], description: 'A JavaScript-powered dictionary retrieving definitions, pronunciation, examples and synonyms through an external API.', features: ['Definitions and parts of speech', 'Audio pronunciation', 'Synonyms and examples'], highlights: ['Fetch API', 'Dynamic DOM updates', 'Error handling'], githubUrl: '[https://github.com/NandaKalyan/English\_Dictionary\_Dynamic\_Website](https://github.com/NandaKalyan/English_Dictionary_Dynamic_Website)', liveDemoUrl: '[https://nk-english-dictionary.netlify.app](https://nk-english-dictionary.netlify.app)', tint: 'gold', mark: 'DE', image: '/assets/projects/dictionary.png' },
  { title: 'Weather Application', category: 'JavaScript', tags: ['JavaScript', 'OpenWeatherMap', 'API'], description: 'A responsive weather application providing real-time weather information for searched cities.', features: ['City search', 'Weather conditions and icons', 'Humidity and pressure details'], highlights: ['OpenWeatherMap API', 'Fetch API', 'Invalid-search feedback'], githubUrl: '[https://github.com/NandaKalyan/Simple\_Weather\_App](https://github.com/NandaKalyan/Simple_Weather_App)', liveDemoUrl: '[https://nk-know-the-weather.netlify.app](https://nk-know-the-weather.netlify.app)', tint: 'sky', mark: 'WA', image: '/assets/projects/weather.png' },
  { title: 'Flappy Bird Game', category: 'Java', tags: ['Java', 'Swing', 'OOP'], description: 'A Java Swing game implementing real-time loops, keyboard controls, gravity, collision detection and score tracking.', features: ['Keyboard controls', 'Random pipe generation', 'Restart and game-over states'], highlights: ['60 FPS game loop', 'Collision detection', 'Object-oriented programming'], githubUrl: '[https://github.com/NandaKalyan/Flappy\_Bird\_Game](https://github.com/NandaKalyan/Flappy_Bird_Game)', tint: 'green', mark: 'FB', image: '/assets/projects/flappy-bird.jpg' },
  { title: 'Advanced Calculator', category: 'JavaScript', tags: ['HTML5', 'CSS3', 'JavaScript'], description: 'A responsive browser calculator supporting arithmetic operations, keyboard controls, input editing and error handling.', features: ['Keyboard input', 'Decimal calculations', 'Clear, delete and error handling'], highlights: ['Enter-to-calculate', 'Backspace and Escape controls', 'Responsive layout'], githubUrl: '[https://github.com/NandaKalyan/Simple-Calculator](https://github.com/NandaKalyan/Simple-Calculator)', liveDemoUrl: '[https://nk-simple-calci.netlify.app](https://nk-simple-calci.netlify.app)', tint: 'slate', mark: 'AC', image: '/assets/projects/calculator.png' },
];
  ...
  return (
    <div className="app-shell">
      ...
      <main>
        ...
        <section className="resume-cta section-pad"><div><span className="section-number">OPEN TO WHAT'S NEXT</span><h2>Ready to build<br /><em>something great?</em></h2></div><div><p>Explore my projects, view my work and connect with me for software development opportunities.</p><div className="hero-actions"><a className="button button-primary" href="/NandaKalyan\_ATS.pdf" download="Nanda-Kalyan-Resume.pdf">Download resume <ArrowUpRight size={17} /></a><button className="button button-quiet" onClick={() => scrollTo('projects')}>View projects <ArrowDownRight size={17} /></button></div></div></section>
      </main>
