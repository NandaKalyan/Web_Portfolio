  ...
  return (
    <div className="app-shell">
      ...
      <main>
        ...
        <section className="stats section-pad"><div className="stat-grid">{[['10+', 'Projects built'], ['150+', 'DSA problems solved'], ['2024', 'Graduate'], ['8.94', 'CGPA']].map(([value, label], index) => <div className="stat" key={label}><span className="stat-index">0{index + 1}</span><strong>{value}</strong><p>{label}</p></div>)}</div></section>
